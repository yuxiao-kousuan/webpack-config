...
module.exports = {
    ...
    output: {
        ...
        //入口文件打包输出的文件名
        filename: 'static/js/[name].js', // 兼容多入口
    ...
    plugins: [
        ...
        new MiniCssExtractPlugin({
            filename: "static/css/[name].css", //【name】为了兼容多入口
            chunkFilename: "static/css/[name].chunk.css", //动态导入的js文件中含有css文件的动态命名，chunk为了和主文件区分
        }),
